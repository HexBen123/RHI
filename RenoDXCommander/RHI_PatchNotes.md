...
- **DLSS On-Screen Indicator Toggle** — New setting to enable/disable the green DLSS text overlay that NVIDIA shows in the corner of games. Global system setting, requires admin (UAC prompt). Found in the Mass DLSS & Streamline section of Settings.
